function [ atom_OD_svd ] = process_list_svd(atom_file_list, basis_svd, back_region)
...
%   images in file_list and removing the background using the vectors with
%   the largest singular values, which are given in basis_svd.
%
%   === Example Usage ===
