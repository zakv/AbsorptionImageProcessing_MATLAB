function [ atom_OD_eig ] = process_series_eig(series_name, basis_eig, mean_back_eig, back_region)
...
%
%   basis_eig should be a basis generated by make_basis_eig()
%
%   mean_back_eig should be the mean background image generated by
%   make_basis_eig()
%
...
%   >> atom_OD = process_series_eig(series_name,basis_eig, mean_back_eig, back_region);
...
atom_OD_eig=get_OD_eig(raw_mean,basis_eig,mean_back_eig,back_region);
end
